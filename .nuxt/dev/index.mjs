...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///home/nogba/walidProject/portfolio/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/nogba/walidProject/portfolio/node_modules/vue-bundle-renderer/dist/runtime.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///home/nogba/walidProject/portfolio/node_modules/ufo/dist/index.mjs';
...
import { createStorage, prefixStorage } from 'file:///home/nogba/walidProject/portfolio/node_modules/unstorage/dist/index.mjs';
...
import { consola } from 'file:///home/nogba/walidProject/portfolio/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///home/nogba/walidProject/portfolio/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/nogba/walidProject/portfolio/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///home/nogba/walidProject/portfolio/node_modules/vue/index.mjs';
import { basename, isAbsolute } from 'file:///home/nogba/walidProject/portfolio/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///home/nogba/walidProject/portfolio/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///home/nogba/walidProject/portfolio/.nuxt/nuxt-icon-server-bundle.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/nogba/walidProject/portfolio/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _sVTLSvoSKc = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/home/nogba/walidProject/portfolio";
...
const _kusDsp = defineCachedEventHandler(async (ctx) => {
...
const _lazy_p66TyD = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_p66TyD, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _kusDsp, lazy: false, middleware: false, method: undefined },
...
const getClientManifest = () => import('file:///home/nogba/walidProject/portfolio/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);

...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CW3Gu_3F.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./default-Bd5hekEB.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-C_Vd0vrh.mjs').then((r) => r.default || r));
